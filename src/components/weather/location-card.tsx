...
import { MapPin, Download, Sparkles, X } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md p-0 overflow-hidden border-0">
        <div className="relative w-full aspect-[3/4] bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 overflow-hidden">
          ...
          <button
            ...
            className="absolute top-6 right-6 p-2 rounded-full bg-white/20 backdrop-blur-md border-2 border-white/40 text-white hover:bg-white/30 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
